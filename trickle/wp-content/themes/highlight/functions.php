...
function highlight_get_footer_copyright($copyright, $preview_atts)
{
    ...
    $copyrightText = __('Proudly powered by Trickle Solutions.');
    $copyrightText = sprintf($copyrightText, '<a target="_blank" href="#" class="mesmerize-theme-link">Trickle Solutions</a>');
